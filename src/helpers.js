...
/**
 * Checks if the content is relevant to Carrier Network Intelligence.
 * @param {string} title - The title of the article.
 * @param {string} content - The content of the article.
 * @returns {boolean} True if relevant, false otherwise.
 */
export function isRelevantToCarrierNetworkAI(title, content) {
    const keywords = [
        // Standards & Orgs
        '3GPP', 'ETSI', 'TM Forum', 'O-RAN', 'ITU-T', 'GSMA',
        
        // Network Generations
        '5G', '6G', '5G-Advanced', '5.5G', 'B5G',
        
        // AI & Intelligence
        'NWDAF', 'RIC', 'MDAF', 'Intent-based', 'Autonomous Network', 'Self-Organizing', 
        'NetGPT', 'AIOps', 'Network AI', 'Zero Touch', 'ZSM', 'Digital Twin',
        
        // Computing & Cloud
        'Computing Force', 'CFN', '算力网络', '算网', 'MEC', 'Edge Computing',
        
        // Network Functions
        'Core Network', 'RAN', 'vRAN', 'Open RAN', 'NFV', 'SDN', 'Slicing',
        '核心网', '接入网', '切片'
    ];
